...
import com.fibear.android.fibear.view.forBear.registerBlocks.RegisterBlocksViewModelFactory
...
class InjectionUtils {
    companion object {
        ...
        fun provideRegisterBlocksViewModelFactory(): RegisterBlocksViewModelFactory = RegisterBlocksViewModelFactory(provideFibearReposiory())
